...
<head>
    ...
    <title>500 - Kesalahan Server | {{ config('app.name', 'Mulia Grup') }}</title>
    ...
    <style>
        ...
        .error-code {
            ...
            line-height: 1;
            margin-bottom: 1rem;
            background: linear-gradient(135deg, var(--ps-red), var(--ps-orange));
    ...
    <div class="error-page">
        <div class="error-card">
            ...
            <p class="error-description">
                Maaf, terjadi kesalahan pada server kami. Kami sedang berusaha memperbaikinya. 
                Silakan coba lagi beberapa saat lagi atau kembali ke beranda.
            </p>
